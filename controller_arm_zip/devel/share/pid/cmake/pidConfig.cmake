...
if("TRUE" STREQUAL "TRUE")
  set(pid_SOURCE_PREFIX /home/ujjawal/controller/controller_arm_zip/src/pid)
  set(pid_DEVEL_PREFIX /home/ujjawal/controller/controller_arm_zip/devel)
  set(pid_INSTALL_PREFIX "")
  set(pid_PREFIX ${pid_DEVEL_PREFIX})
else()
  set(pid_SOURCE_PREFIX "")
  set(pid_DEVEL_PREFIX "")
  set(pid_INSTALL_PREFIX /home/ujjawal/controller/controller_arm_zip/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ujjawal/controller/controller_arm_zip/src/pid/${idir}'.  ${_report}")
    endif()
